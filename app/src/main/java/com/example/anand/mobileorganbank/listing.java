...
public class listing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Cursor r = db.rawQuery("select * from DONREGISTERS where ORGAN = 'Heart'", null);
            if (r.moveToFirst()) {
                a.clear();
            ...
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    AlertDialog.Builder b = new AlertDialog.Builder(listing.this);
                  ...
                  b.setMessage("Are you sure you want to select?");
                    b.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        try {
                            ...
                            smsManager.sendTextMessage(mo, null, "Mr "+nam+" is interested in your Donation(Heart) \nPlease Contact his no. "+mob+" for further details\nThank You!", null, null);
                        ...
                        catch (Exception e)
                        {
                            ...
                            Intent m = new Intent(getApplicationContext(), listing.class);
                            startActivity(m);
