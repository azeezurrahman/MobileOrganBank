...
public class listing3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Cursor r = db.rawQuery("select * from DONREGISTERS where ORGAN = 'Eyes'", null);
            if (r.moveToFirst()) {
                a.clear();
            ...
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    AlertDialog.Builder b = new AlertDialog.Builder(listing3.this);
                    ...
                    b.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            try {
                                ...
                                smsManager.sendTextMessage(mo, null, "Mr "+nam+" is interested in your Donation(Eyes) \nPlease Contact his no. "+mob+" for further details\nThank You!", null, null);
                            ...
                            Intent m = new Intent(getApplicationContext(), listing3.class);
                            startActivity(m);
